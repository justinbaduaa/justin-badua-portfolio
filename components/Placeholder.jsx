...
export default function Placeholder({ title, slug }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white dark:bg-neutral-950 px-6 py-24 text-center text-neutral-500 dark:text-neutral-400">
      <div className="space-y-3">
        <p className="text-sm uppercase tracking-[0.3em] text-neutral-400 dark:text-neutral-500">{title}</p>
        <h1 className="text-3xl font-semibold text-neutral-900 dark:text-neutral-100">Coming soon</h1>
